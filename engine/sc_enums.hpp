...
enum trait_sub_tree_e
{
  ...
  PRIEST_ARCHON,
  PRIEST_ORACLE,
  DRUID_DRUID_OF_THE_CLAW,
  DRUID_WILDSTALKER,
  DRUID_KEEPER_OF_THE_GROVE,
  DEATH_KNIGHT_SANLAYN,
  DEATH_KNIGHT_RIDER_OF_THE_APOCALYPSE,
  DEATH_KNIGHT_DEATHBRINGER,
  DEMON_HUNTER_FELSCARRED,
  DEMON_HUNTER_ALDRACHI_REAVER,
  EVOKER_SCALECOMMANDER,
  EVOKER_FLAMESHAPER,
  EVOKER_CHRONOWARDEN,
  MAGE_SUNFURY,
  MAGE_SPELLSLINGER,
